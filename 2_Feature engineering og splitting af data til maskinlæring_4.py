...
def process_directory(base_dir, set_name):
    ...
    for key, count in samples_count.items():
        if count < min_samples_per_class:
            ...
            print(
                f"Advarsel: Klasse '{key}' i {set_name} har kun {count} samples, kræver mindst {min_samples_per_class}. Udfører data augmentering...")
            ...
            print(f"Tilføjet {needed_augments} nye samples til klasse '{key}' i {set_name}.")
