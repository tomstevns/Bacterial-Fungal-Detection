...
val_datagen = ImageDataGenerator(
    rescale=1. / 255,
    rotation_range=20,    # Apply rotations
...
test_datagen = ImageDataGenerator(rescale=1. / 255, rotation_range=20, zoom_range=0.2, horizontal_flip=True)
...
model = tf.keras.models.Sequential([
    ...
    # Output layer should match number of classes
])
