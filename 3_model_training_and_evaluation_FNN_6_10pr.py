...
param_grid = {
    'learning_rate': [0.0001, 0.00005],  # Experimenting with even smaller learning rates
    'dropout_rate': [0.6, 0.7],  # Increased dropout to reduce overfitting
    'filters': [8, 16],  # Further reduced model complexity
    'rotation_range': [40, 60],  # More aggressive data augmentation
    'zoom_range': [0.3, 0.4],  # More aggressive data augmentation
    'epochs': [10, 20]  # Reducing epochs based on overfitting patterns
}
