...
param_grid = {
    ...
    'dropout_rate': [0.4, 0.7],  # Updated dropout rates for regularization
...
def create_model(learning_rate, dropout_rate, filters, num_classes):
    ...
    model = tf.keras.models.Sequential([
        # Increased regularization strength with L2 and increased dropout rate
        tf.keras.layers.Conv2D(filters, (3, 3), activation='relu', input_shape=(150, 150, 3),
                               kernel_regularizer=tf.keras.regularizers.l2(0.002)),  # Higher L2 regularization
        ...
        tf.keras.layers.Dropout(dropout_rate),  # Dropout for better regularization
        tf.keras.layers.Flatten(),
        tf.keras.layers.Dense(256, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(0.002)),
        # Dense layer with L2
        tf.keras.layers.Dropout(dropout_rate),  # Dropout applied after dense layer
