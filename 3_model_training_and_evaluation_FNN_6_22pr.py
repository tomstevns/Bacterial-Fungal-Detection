...
param_grid = {
    ...
    'dropout_rate': [0.5, 0.7],  # Higher dropout rates to prevent overfitting
    'filters': [32, 64],  # Increasing model complexity by varying filters
    'rotation_range': [30, 50],  # Aggressive data augmentation
    'zoom_range': [0.2, 0.4],  # More aggressive data augmentation
    'epochs': [10, 20]  # More epochs to allow better learning
}
...
for params in param_combinations:
    ...
    train_datagen = ImageDataGenerator(
        ...
        width_shift_range=0.2,  # Moderate shifts to avoid excessive distortion
