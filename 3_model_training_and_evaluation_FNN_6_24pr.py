...
param_grid = {
    ...
    'filters': [16, 32],  # Reducing model complexity by varying filters
    'rotation_range': [50, 60],  # Aggressive data augmentation
    'zoom_range': [0.3, 0.5],  # More aggressive data augmentation
...
def create_model(learning_rate, dropout_rate, filters, num_classes):
    ...
    model = tf.keras.models.Sequential([
        ...
        tf.keras.layers.Dense(256, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(0.007)),
