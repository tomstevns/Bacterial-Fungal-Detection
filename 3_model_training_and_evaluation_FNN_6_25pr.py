...
param_grid = {
    'learning_rate': [0.0005, 0.0001, 0.00001],  # Smaller learning rates for smoother convergence
    'dropout_rate': [0.6, 0.8],  # Higher dropout rates to prevent overfitting
    'filters': [16, 32],  # Reducing model complexity by reducing filters
    'rotation_range': [60],  # Aggressive data augmentation
    'zoom_range': [0.4],  # More aggressive data augmentation
    'epochs': [20, 30]  # More epochs to allow better learning
}
...
for params in param_combinations:
    ...
    train_generator = train_datagen.flow_from_directory(
        train_data_dir, target_size=(150, 150), batch_size=16, class_mode='categorical'  # Reduced batch size for granular updates
    )
