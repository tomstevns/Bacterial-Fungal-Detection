...
param_grid = {
    'learning_rate': [0.00001, 0.000001],  # Further reduced learning rates for more precise tuning
    'dropout_rate': [0.7, 0.9],  # Higher dropout rates to prevent overfitting
    'filters': [8, 16],  # Reduced filters to simplify the model and reduce overfitting
...
def create_model(learning_rate, dropout_rate, filters, num_classes):
    ...
    model = tf.keras.models.Sequential([
        ...
        tf.keras.layers.Conv2D(filters, (3, 3), activation='relu', input_shape=(150, 150, 3),
                               kernel_regularizer=tf.keras.regularizers.l2(0.02)),  # Further increased L2 regularization
...
for params in param_combinations:
    ...
    train_datagen = ImageDataGenerator(
        ...
        width_shift_range=0.3,  # Aggressive shifts to prevent overfitting
