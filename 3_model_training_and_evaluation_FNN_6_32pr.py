...
for params in param_combinations:
    ...
    # Callbacks
    callbacks = [
        ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=3, min_lr=0.00001),  # Reduce LR on plateau
        EarlyStopping(monitor='val_loss', patience=2, restore_best_weights=True),  # Stop if no improvement
