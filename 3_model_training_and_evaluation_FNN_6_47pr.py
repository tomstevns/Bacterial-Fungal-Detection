...
param_grid = {
    ...
    'dropout_rate': [0.4, 0.5],  # Modified dropout rate for better regularization
    'filters': [32, 64],
    'rotation_range': [10, 20],  # Reduced rotation range for controlled augmentation
    'zoom_range': [0.05, 0.1],  # Reduced zoom range
    'epochs': [20, 25]  # Increased epoch range with early stopping
}
...
# Function to create the model based on current hyperparameters with L2 regularization and batch normalization
...
for params in param_combinations:
    ...
    # Callbacks
    callbacks = [
        ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=6, min_lr=0.000001),  # Adjust patience and min_lr
