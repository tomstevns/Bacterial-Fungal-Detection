...
param_grid = {
    'learning_rate': [0.0001, 0.00001],  # Increased initial learning rate for better exploration
    'dropout_rate': [0.5, 0.6],  # Adjusting dropout rate to reduce overfitting
    'filters': [32, 64],  # Range of filters
    'rotation_range': [10, 20],  # Less aggressive augmentations
    'zoom_range': [0.05, 0.1],  # Moderate zoom range
    'epochs': [20, 25]  # Slightly reduced epoch range
}
...
def lr_scheduler(epoch, lr):
    return lr * np.exp(-0.05 * epoch)  # Less aggressive learning rate decay
