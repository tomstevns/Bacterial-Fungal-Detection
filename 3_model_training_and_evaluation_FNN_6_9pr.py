...
def create_model(learning_rate, dropout_rate, filters):
    model = tf.keras.models.Sequential([
        ...
        tf.keras.layers.Dense(256, activation='relu',
                              kernel_regularizer=tf.keras.regularizers.l2(0.01)),  # Reduced dense units
...
for params in param_combinations:
    ...
    # Log the results
    log_results(dict(learning_rate=learning_rate, dropout_rate=dropout_rate, filters=filters, rotation_range=rotation_range,
                     zoom_range=zoom_range, epochs=epochs), test_acc, val_loss)
