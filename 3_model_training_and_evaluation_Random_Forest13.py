...
if best_model is None:
    ...
    rf_grid_search = GridSearchCV(estimator=rf, param_grid=rf_param_grid, cv=7, n_jobs=-1, verbose=4)
    gbt_grid_search = GridSearchCV(estimator=gbt, param_grid=gbt_param_grid, cv=4, n_jobs=-1, verbose=4)
