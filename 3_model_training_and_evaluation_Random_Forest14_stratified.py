...
if best_model is None:
    ...
    stratified_kf_gbt = StratifiedKFold(n_splits=2)  # Stratified K-Fold for Gradient Boosting
    ...
    gbt_grid_search = GridSearchCV(estimator=gbt, param_grid=gbt_param_grid, cv=stratified_kf_gbt, n_jobs=-1, verbose=4)
