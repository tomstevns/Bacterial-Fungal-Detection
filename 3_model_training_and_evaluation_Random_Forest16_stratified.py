...
if best_model is None:
    ...
    abt_param_grid = {
        'algorithm': ['SAMME.R'],  # Switch to SAMME.R
        'n_estimators': [100, 200, 300],  # Focus on a moderate range of estimators
        'learning_rate': [0.001,0.005,0.01, 0.05, 0.1]  # Keep this range of learning rates for further exploration
    }
    ...
    # Define the AdaBoost classifier using the custom base estimator
