...
# Aggressive augmentation for Bacillus
def augment_image(img, img_size, is_bacillus=False):
    ...
    if is_bacillus:  # Apply more augmentation for Bacillus
...
# Function to load images and labels with aggressive augmentation for Bacillus
    ...
    for cls in expected_classes:
        ...
        for img_name in os.listdir(class_dir):
            ...
            try:
                ...
                if augment:
                    is_bacillus = cls == 'Bacillus'  # Apply more aggressive augmentations for Bacillus
                    img_resized = augment_image(img_resized, img_size, is_bacillus=is_bacillus)
