...
# Aggressive augmentation for Bacillus and stapholococcus
def augment_image(img, img_size, is_bacillus=False, is_staph=False):
    ...
    if is_bacillus or is_staph:  # Apply more augmentation for Bacillus and stapholococcus
        img_brightened = resize(img_brightened, (img_brightened.shape[0] + 10, img_brightened.shape[1] + 10))  # Zoom effect
    img_resized = resize(img_brightened, img_size)  # Resize back to the desired size
    return img_resized

# Function to load images and labels with aggressive augmentation for Bacillus and stapholococcus
        ...
        for img_name in os.listdir(class_dir):
            ...
            try:
                ...
                if augment:
                    ...
                    img_resized = augment_image(img_resized, img_size, is_bacillus=is_bacillus, is_staph=is_staph)
...
param_grid = {
    ...
    'class_weight': [class_weights_dict]  # Use manually adjusted class weights
}
